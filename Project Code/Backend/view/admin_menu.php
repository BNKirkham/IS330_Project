<?php
    ...
    if(isset($_SESSION['current_user_team_id'])) {
      ...
      $stmt = $db->prepare("SELECT FirstName, LastName, Color FROM People JOIN TeamConnections ON People.PersonID = TeamConnections.PersonID WHERE TeamConnections.TeamID = :teamID");
      $stmt->bindParam(':teamID', $teamID);
