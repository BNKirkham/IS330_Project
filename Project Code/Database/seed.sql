...
INSERT INTO People (FirstName, Color)
VALUES ('Brittany', 'Green'),
	   ('Lily', 'Pink');

INSERT INTO Tasks (TagID, DueBy, Description)
VALUES (1, '2023-9-30', 'Couch warranty');

INSERT INTO Meetings (TagID, Date, Description)
VALUES (2, '2023-9-23', 'Karate Orientation');

INSERT INTO Events (TagID, Weekday, TimeStart, TimeEnd, StartDate, EndDate, Description)
